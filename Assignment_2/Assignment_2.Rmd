...
nrow(validationset)
testset<-data.frame(Age = 40, Experience = 10, Income = 84, Family = 2, CCAvg = 2, 
...
normvar<-c('Age',"Experience","Income","Family","CCAvg","Mortgage","Securities.Account",
...
plot(model$results$k,model$results$RMSE, type = 'o')
...
# on comparing the confusion matrix of validation set and testing set it can be seen that accuracy
#and sensitivity of validation is slightly greater than test set.
